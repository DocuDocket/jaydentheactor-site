  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 30%, rgba(37,99,235,0.26), rgba(168,85,247,0.18), rgba(255,255,255,0) 70%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 40% 40%, rgba(249,115,22,0.22), rgba(34,197,94,0.14), rgba(255,255,255,0) 70%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 50%, rgba(16,185,129,0.18), rgba(59,130,246,0.14), rgba(255,255,255,0) 70%)",
        }}
